...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["payments-payments-module"], {
  ...
  function srcAppPaymentsPaymentsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        /*! import() | payment-confirm-payment-confirm-module */
        "payment-confirm-payment-confirm-module").then(__webpack_require__.bind(null,
        /*! ./payment-confirm/payment-confirm.module */
        "./src/app/payments/payment-confirm/payment-confirm.module.ts")).then(function (m) {
  ...
  function srcAppPaymentsPaymentsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PaymentsPage = /*#__PURE__*/function () {
      //cart: Product[] = [];
      function PaymentsPage(cartService, alertController, fbs) {
        _classCallCheck(this, PaymentsPage);

        this.cartService = cartService;
        this.alertController = alertController;
        this.fbs = fbs;
        this.cart = this.cartService.getCart(); //creating the product list containing the name and the number 
        //of items

        this.ProductList = []; //payment amoiunt

        this.pay_amount = this.total(); //getting today's date
      ...
      _createClass(PaymentsPage, [{
        ...
        value: function ngOnInit() {
          this.cart = this.cartService.getCart(); //adding order values to orders array
        }
      }, {
        key: "total",
        ...
        key: "presentAlert",
        value: function presentAlert(noti_header, noti_subheader, noti_message) {
        ...
        key: "email_customer",
        value: function email_customer(receiver_email, subject, body) {
          Email.send({
        ...
        value: function pay() {
          ...
          this.body_mail_order = "<table><thead><tr style='background-color: maroon;color: white;'>" + "<th colspan='2'><h1><br>Thank you for your order</h1></th></tr></thead><tbody><tr>" + "<td colspan='2'><br>Hi <b>" + this.name + ",</b> <br><br>Just to let you know — we've received " + "your order <b>#9412</b> ,and it is now being processed:<br><br>Payment Method : <b>" + this.pay_method + ".</b><br>" + "<h2><b>[Order #9412] (" + this.today + ")</b></h2></td></tr><tr><td><b>Products</b></td>" + "<td>Denim Jeans(3in1) - 32 [x 2] <br><br></td></tr> <b><br><tr><td><b>Amount</b></td>" + "<td>30,000 Frw <br><br></td></tr><tr><td><b>Shipping</b></td><td>Free Shipping <br><br></td>" + "</tr><tr><td><b>Total</b></td><td>30,000 Frw <br><br></td></tr><tr><td><b>Shipping Address</b></td>" + "<td>" + this.ship_address + " <br><br></td></tr></tbody><tfoot><tr><th colspan='2'>Thank you for shopping with" + "<a href='https://kstorez.com'>Kstorez</a></th></tr></tfoot></table>"; //checking the payment method chosen by the customer
          ...
          if (this.pay_method == "mobile Money / credit card") {
            ...
            this.orderEmail(); //proceeding with payment

            makePayment(this.pay_amount, this.email, this.phone, this.name);
          } else {
            //sending order email
            this.orderEmail(); //saving the order details in the database
